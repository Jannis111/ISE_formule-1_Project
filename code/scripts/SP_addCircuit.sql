/*
    Usecase: Deze procedure heeft betrekking tot het usecase "Toevoegen Circuit".
    Beschrijving:
       Dit stored procedure voegt een circuit toe aan de database.
*/
...
CREATE OR ALTER PROCEDURE SP_addCircuit
	@newCircuitName NVARCHAR(60),
	@newCircuitCity NVARCHAR(60),
	@newCircuitCountry NVARCHAR(60)
AS
BEGIN
	...
	BEGIN TRY
		...
		--Insert request for storedprocedure execution
